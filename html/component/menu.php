                    ...
                    <div class="menu-top">
						<div class="col1">
							<div class="h_nav">
								<h4>Submenu1</h4>
									<ul>
										<li><a href="html/product.html">Accessories</a></li>
										<li><a href="html/product.html">Bags</a></li>
										<li><a href="html/product.html">Caps & Hats</a></li>
										<li><a href="html/product.html">Hoodies & Sweatshirts</a></li>
						...
						<div class="col1">
							<div class="h_nav">
								<h4>Submenu2</h4>
								<ul>
										<li><a href="html/product.html">Jackets & Coats</a></li>
										<li><a href="html/product.html">Jeans</a></li>
										<li><a href="html/product.html">Jewellery</a></li>
										<li><a href="html/product.html">Jumpers & Cardigans</a></li>
										<li><a href="html/product.html">Leather Jackets</a></li>
										<li><a href="html/product.html">Long Sleeve T-Shirts</a></li>
									</ul>	
							</div>							
						</div>
						<div class="col1">
							<div class="h_nav">
								<h4>Submenu3</h4>
									<ul>
										...
										<li><a href="html/product.html">Shoes, Boots & Trainers</a></li>
										<li><a href="html/product.html">Sunglasses</a></li>
										<li><a href="html/product.html">Sweatpants</a></li>
										<li><a href="html/product.html">Swimwear</a></li>
										<li><a href="html/product.html">Trousers & Chinos</a></li>
						...
						<div class="col1">
							<div class="h_nav">
								...
								<ul>
									...
									<li><a href="html/product.html">Underwear & Socks</a></li>
						...
						<div class="col1 col5">
						<img src="views/images/me.png" class="img-responsive" alt="">
						</div>
			...
			<li class="dropdown mega-dropdown active">
				...
				<div class="dropdown-menu mega-dropdown-menu">
                    <div class="menu-top">
						...
						<div class="col1 col5">
						<img src="views/images/me1.png" class="img-responsive" alt="">
						</div>
						<div class="clearfix"></div>
					</div>                  
				</div>				
